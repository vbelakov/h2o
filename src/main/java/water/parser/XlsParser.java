...
class XlsParser extends Parser {
  ...
  private ArrayList<Props> _props = new ArrayList<Props>();
  ...
  private ArrayList<String> _sst = new ArrayList<String>();
  private ArrayList<Sheet> _boundsheets = new ArrayList<Sheet>();
  ...
  private ArrayList<XF> _xfRecords = new ArrayList<XF>();

  /** List of default date formats used by Excel */
  private static HashMap<Integer,String> DATEFORMATS = new HashMap<Integer,String>();
  static {
  ...
  private static HashMap<Integer,String> NUMBERFORMATS = new HashMap<Integert,String>();
  static {
